...
public class PageQueryBaseResponse<T> {
    ...
    private PageQueryBaseResponse.Pagination pagination;
    ...
    public static <T> PageQueryBaseResponse<T> pagingResponse(List<T> items, int startRow, int pageSize,
        ...
        PageQueryBaseResponse.Pagination pagination = parsePagination(startRow, totalRecordCount, pageSize);
        pagingResponse.setItems(items);
        pagingResponse.setPagination(pagination);
        return pagingResponse;
    }

    private static PageQueryBaseResponse.Pagination parsePagination(int startRow, int totalCount, int pageSize) {
        int pageCount = 0;
        ...
        PageQueryBaseResponse.Pagination pagination = new PageQueryBaseResponse.Pagination();
    ...
    public PageQueryBaseResponse.Pagination getPagination() {
        return this.pagination;
    }

    public void setPagination(PageQueryBaseResponse.Pagination pagination) {
